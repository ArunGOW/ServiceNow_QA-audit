  ...
  return (
    <>
      ...
      <Container className="mt-5">
        ...
        {/* Incident Table */}
<div className="mt-4 p-4 border rounded-4 bg-white shadow-lg">
...
>
  <thead>
    ...
    >
      <th className="py-3 border-end">INCIDENT NO</th>
      <th className="py-3 border-end text-start">SHORT DESCRIPTION</th>
      <th className="py-3 border-end">STATUS</th>
      <th className="py-3 border-end">ASSIGNED TO</th>
  ...
  <tbody>
    {incidents.map((incident, index) => (
      ...
      >
        <td className="fw-semibold text-dark border-end">
          {incident.incident_number || "N/A"}
        </td>

        {/* 👇 SHORT DESCRIPTION LEFT ALIGNED */}
        <td className="text-muted border-end text-start">
          {incident.short_description || "N/A"}
        </td>
