...
const Dashboard = () => {
  ...
  const [totalCount, setTotalCount] = useState(0); // backend should return total count
  const limit = 10;

  // ✅ Fetch incidents from API with skip & limit
  const fetchIncidents = async (page = 1) => {
    ...
    try {
      ...
      // Expect backend response shape: { incidents: [...], total: 200 }
