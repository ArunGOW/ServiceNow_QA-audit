...
const Sidebar = () => {
  return (
    <div className="sidebar">
      ...
      <nav>
        <NavLink to="/pending-qa" activeClassName="active">
          <FaStar /> Pending QA
        </NavLink>
        <NavLink to="/processed-qa" activeClassName="active">
          <FaStar /> Processed QA
        </NavLink>
        <NavLink to="/pending-grooming" activeClassName="active">
          <FaStar /> Pending Grooming
        </NavLink>
        <hr />
        <NavLink to="/import-incident" activeClassName="active">
          <FaStar /> Import Incident
        </NavLink>
        <NavLink to="/export-incident" activeClassName="active">
          <FaStar /> Export Incident
        </NavLink>
      </nav>
    </div>
  );
