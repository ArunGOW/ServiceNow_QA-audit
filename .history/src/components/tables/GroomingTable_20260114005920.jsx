...
//     </div>
 ...
 <div className="bg-white rounded-4 shadow-sm border overflow-hidden">
  {/* ✅ Clean Premium Banner (No Background) */}
  <div className="d-flex justify-content-between align-items-center px-4 py-3 border-bottom">
    <div className="d-flex align-items-center">
      <div className="header-accent-line me-3"></div>
      <div>
        ...
        <div className="d-flex align-items-center mt-1">
          ...
          <small className="text-muted fw-medium" style={{ fontSize: '0.72rem' }}>
            Action required for quality assessment
          </small>
        </div>
      </div>
    </div>

    {/* ✅ Attractive Incident Count Pill */}
  ...
  {loading ? (
    <div className="text-center py-5">
      <Spinner animation="border" size="sm" variant="primary" opacity="0.5" />
    </div>
  ) : (
    <div className="table-responsive">
      <Table hover className="align-middle mb-0 compact-table">
        ...
        <tbody>
          {incidents.length > 0 ? (
            incidents.map((incident, index) => (
              <tr key={incident.sid || index} className="compact-row">
                ...
                <td>
                  <div className="text-truncate text-secondary" style={{ maxWidth: "220px", fontSize: "0.8rem" }}>
                ...
                <td>
                   <div className="d-flex align-items-center">
                      <div className="avatar-xs-lite me-2">{incident.qc_analyst?.charAt(0) || "U"}</div>
                      <span className="fw-medium text-dark" style={{ fontSize: '0.8rem' }}>{incident.qc_analyst || "NA"}</span>
                   </div>
                </td>
              </tr>
            ))
          ) : (
            <tr><td colSpan="7" className="text-center py-5 text-muted small">No grooming incidents found.</td></tr>
          )}
        </tbody>
      </Table>
    </div>
