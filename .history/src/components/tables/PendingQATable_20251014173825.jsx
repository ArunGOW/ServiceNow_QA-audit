...
//   setFormData({
//     ...incident, // existing incident fields
//     incident_sid: incident.sid,
//     qc_analyst: user?.full_name || "", // ✅ always set to current logged-in user
//   });

//   console.log("🔹 QA Agent (current logged-in user):", user?.full_name);
...
//     audit_date: incident.audit_date || new Date().toISOString().split("T")[0], // Current date if empty
//   });
...
>
  ...
  <option value="chetana">Chetana</option>
  <option value="sagnik">Sagnik</option>
  <option value="nithin">Nithin</option>
  <option value="shekhar">Shekhar</option>
