...
//      <Col md={4}>
//       <div className="info-field">
//         <span className="fw-bold me-2 d-block">Handled By:</span>
//         {loadingUsers ? (
...
//               <option key={index} value={user.username || user.name}>
//                 {user.username
...
>
  ...
  {users
    .filter((u) => u.type?.toLowerCase() === "agents")
    .map((u) => (
      <option key={u.user_sid} value={u.user_sid}>
        {u.name ||
          `${u.first_name ? u.first_name.charAt(0).toUpperCase() + u.first_name.slice(1).toLowerCase() : ""} ${
            u.last_name ? u.last_name.charAt(0).toUpperCase() + u.last_name.slice(1).toLowerCase() : ""
          }`.trim() ||
          "Unknown"}
      </option>
    ))}
