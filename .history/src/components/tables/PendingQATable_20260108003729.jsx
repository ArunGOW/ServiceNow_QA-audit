            ...
            <Form>
              ...
              <div className="mb-4 p-3 border rounded shadow-sm bg-light">
                ...
                <Row className="mb-3">
                  ...
                  <Col md={4}>
                   {/* 4. Score Display */}
<div className="mt-3 mb-3 p-2 bg-dark text-white rounded d-flex justify-content-between px-3">
 ...
 <Form.Group className="mb-3">
  <Form.Label className="fw-bold">QA Comments Selection</Form.Label>
  
  {/* 1. The Input Field showing selected Category Names */}
  <Form.Control
    type="text"
    readOnly
  ...
  {/* 2. The Dropdown - Hidden when a specific category is selected (activeCategory) */}
  {!activeCategory ? (
    <Dropdown className="w-100">
      <Dropdown.Toggle variant="outline-dark" className="w-100 text-start d-flex justify-content-between align-items-center">
        ...
        {qualityPoints.map((category) => {
          ...
          return (
            ...
            >
              ...
              {count > 0 && <span className="badge bg-success rounded-pill">{count}</span>}
            </Dropdown.Item>
          );
        })}
      </Dropdown.Menu>
    ...
    /* 3. The Sub-points View - Shows only when a category is clicked */
    <div className="p-3 border rounded bg-white shadow-sm border-primary">
      <div className="d-flex justify-content-between align-items-center border-bottom pb-2 mb-3">
        <h6 className="mb-0 text-primary fw-bold">
          ...
          {activeCategory.check_point_name}
        </h6>
          ...
          <Form.Check
            ...
            label={
              <div className="d-flex justify-content-between w-100">
                <span className="small">{sub.sub_check_point_name}</span>
                <span className="badge bg-light text-dark border">+{sub.max_points}</span>
              </div>
            }
