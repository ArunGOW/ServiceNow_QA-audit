...
const PendingQATable = ({ incidents, loading, refresh }) => {
  ...
  <div className="bg-white rounded-4 shadow-sm border overflow-hidden position-relative animate__animated animate__fadeIn" style={{ maxHeight: '100vh' }}>
  <ToastContainer position="top-right" autoClose={2500} hideProgressBar />
    ...
    <div className="d-flex justify-content-between align-items-center">
      <div className="d-flex align-items-center">
        ...
        <div>
          ...
          <small className="text-muted fw-medium" style={{ fontSize: '11px' }}>10 items visible in current view</small>
        </div>
      </div>

      <div className="d-flex align-items-center">
        {/* ✅ Compact Premium Badge */}
        <div className="premium-counter-compact shadow-sm">
  ...
  {loading ? (
    ...
    <div className="table-responsive" style={{ overflow: 'hidden' }}>
      <table className="table table-hover align-middle mb-0 high-density-table">
        <thead className="bg-light">
          <tr>
            <th style={{ width: "50px" }} className="ps-4 text-center">
              <input
                type="checkbox"
            ...
            <th className="density-header">INCIDENT</th>
            <th className="density-header">DESCRIPTION</th>
            <th className="density-header">HANDLED BY</th>
            <th className="density-header">TIMELINE</th>
            <th className="density-header text-end pe-4">AUDITOR</th>
          </tr>
        </thead>
        <tbody>
