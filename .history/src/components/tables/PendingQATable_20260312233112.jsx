...
const PendingQATable = ({ incidents, loading, refresh }) => {
  ...
  return (
    ...
    <div className="bg-white rounded-4 shadow-sm border overflow-hidden position-relative">
      ...
      <span className="badge-text" style={{ fontSize: '0.65rem' }}>TOTAL PENDING</span>
      ...
      {loading ? (
        ...
        <div className="table-responsive">
          ...
          {incidents.slice(0, 10).map((incident, index) => (
            <tr key={incident.sid || index} className="density-row">
              ...
              <td className="fw-bold">
                <div 
                  onClick={() => handleOpenModal(incident)} 
                  className="incident-link-slim text-primary cursor-pointer"
                >
              ...
              <td>
                <div className="text-truncate" style={{ maxWidth: "280px", fontSize: '13px', color: '#475569' }}>
                  {incident.short_description || "N/A"}
                </div>
              </td>
              ...
              <div className="mb-4 p-3 border rounded shadow-sm bg-light">
                ...
                <Row className="align-items-end">
                  ...
                  <Col md={4}>
                    ...
                    {/* Score Summary Footer */}
                    <div className="mb-3">
  <label className="form-label fw-bold">SLA Breached</label>
  <select
    className="form-select"
    name="sla_breached"
    value={formData.sla_breached ?? ""}
    onChange={(e) =>
      setFormData({ ...formData, sla_breached: e.target.value === "true" })
    }
  >
