...
//       logger.warn("Update failed: Incident SID missing.");
...
//       logger.info("Incident updated:", res.data);
//       showToast(`✅ ${res.data.message}`);
...
//   const handleAssign = async () => {
//     if (!selectedUser) {
//       logger.warn("Assign attempt failed: No user selected.");
//       return showToast("Please select a user!", "warning");
//     }

//     if (selectedIncidents.length === 0) {
//       logger.warn("Assign attempt failed: No incidents selected.");
//       return showToast("Select at least one incident!", "warning");
//     }

//     if (!loggedUserSid) {
//       logger.error("Assign failed: Logged-in user SID missing.");
...
//       logger.info("Incidents successfully assigned:", selectedIncidents);
//       showToast("✅ Incidents assigned successfully!", "success");
