    ...
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        <div style={styles.titleArea}>
          <h2 style={styles.logo}>Aura<span style={{ color: '#4f46e5' }}>Analytics</span></h2>
...
const styles = {
  ...
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', backgroundColor: '#fff', padding: '10px 18px', borderRadius: '10px', boxShadow: '0 2px 4px rgba(0,0,0,0.03)' },
  titleArea: { display: 'flex', alignItems: 'center', gap: '20px' },
  logo: { margin: 0, fontSize: '18px', fontWeight: '900', letterSpacing: '-0.4px', color: '#1e293b' },
  ...
  inputSlim: { padding: '5px 8px', borderRadius: '6px', border: '1px solid #e2e8f0', fontSize: '11px', background: '#f8fafc' },
  resetBtn: { background: 'none', border: 'none', color: '#ef4444', fontSize: '11px', cursor: 'pointer', fontWeight: '600' },
  kpiRow: { display: 'flex', backgroundColor: '#fff', borderRadius: '10px', marginBottom: '12px', padding: '14px 0', boxShadow: '0 1px 2px rgba(0,0,0,0.02)' },
