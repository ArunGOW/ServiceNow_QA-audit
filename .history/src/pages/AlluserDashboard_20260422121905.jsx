...
<section style={styles.card}>
  <div style={styles.cardHeader}>
    <h6 style={styles.cardTitle}>Quality Overview</h6>
  </div>
  <div style={{ ...styles.tableScroll, display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
    
    {/* Center Label for Total Tickets */}
    <div style={{ position: 'absolute', textAlign: 'center', zIndex: 1 }}>
      <div style={{ fontSize: '10px', fontWeight: '800', color: '#94a3b8', textTransform: 'uppercase' }}>Total</div>
      <div style={{ fontSize: '22px', fontWeight: '900', color: '#1e293b' }}>{summary.total_tickets}</div>
    </div>
    ...
    <ResponsiveContainer width="100%" height={250}>
      <PieChart>
        ...
        <Pie
          ...
          cx="50%"
          cy="50%"
          innerRadius={75}   // Thinner ring for premium look
          outerRadius={95}
          paddingAngle={8}   // More gap between segments
          dataKey="value"
          stroke="none"
          filter="url(#shadow)"
          animationBegin={0}
