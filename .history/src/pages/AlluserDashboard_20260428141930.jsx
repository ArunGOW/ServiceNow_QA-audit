...
/>
  ...
  <span style={{
    ...
    ...(incident.status === 'resolved' ? styles.badgeResolved : 
        incident.status === 'escalated' ? styles.badgeEscalated : 
        styles.badgeDefault)
  }}>
    {/* Adding a small dot icon for a premium look */}
    <i className="bi bi-circle-fill" style={{ fontSize: '6px', marginRight: '6px' }}></i>
    {incident.status?.toUpperCase()}
  </span>
</td>                        <td style={styles.td}>{incident.resolution_shared || "---"}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
...
mainGrid: { 
  ...
  // Default for In Progress / On Hold
  badgeDefault: {
