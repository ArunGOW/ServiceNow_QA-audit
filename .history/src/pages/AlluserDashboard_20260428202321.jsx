        ...
        <tbody>
          {agentsList.map((a, i) => (
            <tr key={i} style={styles.tr} onClick={() => handleAnalystClick(a)}>
              ...
              <td style={styles.td}>
  <div style={{ fontWeight: '700', color: '#1e293b' }}>{analyst.totalHandled}</div>
</td>
...
<td style={styles.td}>
  <div style={{ display: 'flex', gap: '8px' }}>
    ...
    <div style={styles.countBadgeInc}>
      ...
      <span style={styles.countValue}>{analyst.incidentCount}</span>
    </div>
    
    {/* Request Count Badge */}
    <div style={styles.countBadgeRitm}>
      <span style={styles.countLabel}>RITM</span>
      <span style={styles.countValue}>{analyst.requestCount}</span>
    </div>
  </div>
</td>
            </tr>
