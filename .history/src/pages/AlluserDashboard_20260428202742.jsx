...
<th style={styles.th}>Type Breakdown</th> {/* New Column */}
<th style={styles.th}>Quality Score</th>
  ...
  <td style={styles.td}>
  <div style={{ fontWeight: '700', color: '#1e293b' }}>{a.total_tickets}</div>
</td>

{/* NEW COLUMN: Type Breakdown */}
<td style={styles.td}>
  <div style={{ display: 'flex', gap: '8px' }}>
    {/* Incident Count (INC prefix) */}
    <div style={styles.countBadgeInc}>
      <span style={styles.countLabel}>INC</span>
      <span style={styles.countValue}>
        {/* We filter the analyst's specific tickets here */}
        {a.tickets?.filter(t => t.incident_number?.startsWith('INC')).length || 0}
      </span>
    </div>
    
    {/* Request Count (RITM prefix) */}
    <div style={styles.countBadgeRitm}>
      <span style={styles.countLabel}>RITM</span>
      <span style={styles.countValue}>
        {a.tickets?.filter(t => t.incident_number?.startsWith('RITM')).length || 0}
      </span>
    </div>
  </div>
</td>
