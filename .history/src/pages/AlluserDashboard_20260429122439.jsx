...
/>
  ...
  <div style={styles.pageIndicator}>
    Page <span style={styles.pageNumber}>{currentPage}</span> 
    of {Math.ceil(totalPending / perPage) || 1}
  </div>
  ...
  <button 
    ...
    style={{
      ...styles.pagBtn,
      ...(currentPage >= Math.ceil(totalPending / perPage) ? styles.pagBtnDisabled : {})
    }}
  >
...
mainGrid: { 
 ...
 premiumPill: {
  ...
  // Add or replace these in your styles object
paginationArea: {
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'center',
