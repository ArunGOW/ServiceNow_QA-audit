  ...
  <>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
      ...
      <div style={styles.dropdownContainer}>
        ...
        <button onClick={resetDetailDates} style={{ ...styles.resetBtn, height: '32px' }}>
    ...
    <div style={styles.tableScroll}>
      {agentTickets && agentTickets.length > 0 ? (
            ...
            <tbody>
              {agentTickets.map((t, idx) => (
                <tr key={idx} style={styles.tr}>
                  ...
                  <td style={styles.td}>{t.resolution_shared || "---"}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div style={styles.noDataContainer}>
          <i className="bi bi-clipboard-x" style={styles.noDataIcon}></i>
          <p style={styles.noDataText}>No Data Found</p>
          <span style={styles.noDataSubtext}>
            No tickets found for {selectedQaDetail.label} in the selected date range.
          </span>
        </div>
      )}
    </div>
