...
const [timeframe, setTimeframe] = useState('overall');
  ...
  switch (s) {
    case 'resolved':
      return { backgroundColor: '#e26d24', color: '#f8eded', border: '1px solid #bbf7d0' };
    case 'escalated':
      return { backgroundColor: '#e65b5b', color: '#f8eded', border: '1px solid #fecaca' };
    case 'in progress':
...
mainGrid: { 
 ...
 premiumPill: {
  ...
  pillResolved: {
    backgroundColor: '#3cf081', // Dark green
