...
const AllusersDashboard = () => {
  ...
  <div style={{ 
    ...
    {/* Attractive Agent Name Title */}
    <div style={{ textAlign: 'right' }}>
      <span style={{ display: 'block', fontSize: '10px', color: '#94a3b8', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
        Analyst Records
      </span>
  ...
  <div style={{ ...styles.tableScroll, overflowY: 'auto' }}>
    <table style={{ ...styles.table, borderCollapse: 'separate', borderSpacing: '0' }} className="refined-table compact-view">
      <thead style={{ position: 'sticky', top: 0, background: '#f8fafc', zIndex: 10 }}>
        <tr>
          <th style={{ ...styles.th, padding: '10px 16px', fontSize: '11px' }} className="small-header">INCIDENT NO</th>
          <th style={{ ...styles.th, padding: '10px 16px', fontSize: '11px' }} className="small-header">DESCRIPTION</th>
          <th style={{ ...styles.th, padding: '10px 16px', fontSize: '11px' }} className="small-header text-center">STATUS</th>
          <th style={{ ...styles.th, padding: '10px 16px', fontSize: '11px' }} className="small-header text-center">PHASE</th>
        </tr>
      </thead>
      <tbody>
        {agentTickets.map((t, idx) => (
          ...
          >
            {/* Incident No with # prefix and hover underline */}
            <td style={{ ...styles.td, padding: '6px 16px' }}>
              <div 
                style={{
                  color: '#6366f1',
                  fontWeight: '700',
            ...
            {/* Status with Round Pills */}
            <td style={{ ...styles.td, padding: '6px 16px', textAlign: 'center' }}>
              <span style={{
                ...getStatusStyle(t.status),
                padding: '2px 10px',
                borderRadius: '50px',
  ...
  <div style={{ 
    ...
    <div style={{ fontSize: '12px', color: '#64748b', fontWeight: '600' }}>
      Page <span style={{ color: '#1e293b' }}>{detailPage}</span> of {Math.ceil((totalDetailTickets || 0) / 10) || 1}
    </div>
    ...
    <button
      ...
      style={{
        ...styles.pagBtn,
        opacity: detailPage >= Math.ceil(totalDetailTickets / 10) ? 0.5 : 1,
        borderRadius: '8px',
        fontSize: '12px'
      }}
    >
