...
const AllusersDashboard = () => {
  ...
  return (
    <div className="db-root">
      ...
      ══════════════════════════════════════════════════ */}
      {activeTab === 'team' && (
        <div className="db-banner-v2">

          {/* ── Row 1 : Ticket Volume ── */}
          <div className="dbv2-section-label">Ticket Volume</div>
          <div className="dbv2-row dbv2-row-3">

            {/* Total Tickets */}
            <div
              className={`dbv2-stat c-violet clickable ${!showSla && viewMode === 'list' ? 'active-stat' : ''}`}
              onClick={() => setShowSla(false)}
            >
              <div className="dbv2-stat-icon ic-violet">
                <i className="bi bi-ticket-perforated-fill" style={{ color: '#6366f1', fontSize: 15 }}></i>
              </div>
              <div className="dbv2-stat-lbl">Total Tickets</div>
              <div className="dbv2-stat-val violet">
                {(viewMode === 'list' ? summary.total_tickets : selAgent?.total_tickets) || 0}
              </div>
              <div className="dbv2-stat-sub">
                <span className="dbv2-chip chip-violet">INC {incCount}</span>
                <span className="dbv2-sep">·</span>
                <span className="dbv2-chip chip-blue">RIT {ritCount}</span>
              </div>
              <div className="dbv2-progress-bar">
                <div className="dbv2-progress-fill" style={{ width: `${incRatio}%`, background: 'linear-gradient(90deg,#6366f1,#3b82f6)' }} />
              </div>
              <div className="dbv2-stat-foot">
                <span className="dbv2-foot-lbl">INC ratio</span>
                <span className="dbv2-foot-val" style={{ color: '#6366f1' }}>{incRatio}%</span>
              </div>
            </div>

            {/* Unassigned QA */}
            <div className="dbv2-stat c-amber">
              <div className="dbv2-stat-icon ic-amber">
                <i className="bi bi-inbox-fill" style={{ color: '#f59e0b', fontSize: 15 }}></i>
              </div>
              <div className="dbv2-stat-lbl">Unassigned QA</div>
              <div className="dbv2-stat-val amber">{summary.unassigned_qa_tickets || 0}</div>
              <div className="dbv2-stat-sub">
                <span className="dbv2-chip chip-amber">Awaiting assignment</span>
              </div>
              <div className="dbv2-progress-bar">
                <div className="dbv2-progress-fill" style={{ width: `${unassignedPct}%`, background: '#f59e0b' }} />
              </div>
              <div className="dbv2-stat-foot">
                <span className="dbv2-foot-lbl">of total tickets</span>
                <span className="dbv2-foot-val" style={{ color: '#d97706' }}>{unassignedPct}%</span>
              </div>
            </div>

            {/* Pending Assigned */}
            <div className="dbv2-stat c-slate">
              <div className="dbv2-stat-icon ic-slate">
                <i className="bi bi-hourglass-split" style={{ color: '#64748b', fontSize: 15 }}></i>
              </div>
              <div className="dbv2-stat-lbl">Pending Assigned</div>
              <div className="dbv2-stat-val slate">{summary.pending || 0}</div>
              <div className="dbv2-stat-sub">
                <span className="dbv2-chip chip-slate">QC remaining</span>
                <span className="dbv2-sep">·</span>
                <span className="dbv2-chip chip-amber">{summary.qc_remaining || 0} in queue</span>
              </div>
              <div className="dbv2-progress-bar">
                <div className="dbv2-progress-fill" style={{ width: `${pendingPct}%`, background: '#64748b' }} />
              </div>
              <div className="dbv2-stat-foot">
                <span className="dbv2-foot-lbl">QC backlog</span>
                <span className="dbv2-foot-val" style={{ color: '#475569' }}>{summary.qc_remaining || 0} tickets</span>
              </div>
            </div>
          </div>

          {/* ── Row 2 : QA Outcomes ── */}
          <div className="dbv2-section-label" style={{ marginTop: 4 }}>QA Outcomes</div>
          <div className="dbv2-row dbv2-row-4">

            {/* QA Passed */}
            <div className="dbv2-stat c-green">
              <div className="dbv2-stat-icon ic-green">
                <i className="bi bi-shield-check" style={{ color: '#10b981', fontSize: 15 }}></i>
              </div>
              <div className="dbv2-stat-lbl">QA Passed</div>
              <div className="dbv2-stat-val green">
                {(viewMode === 'list' ? summary.passed : selAgent?.passed) || 0}
              </div>
              <div className="dbv2-stat-sub">
                <span className="dbv2-chip chip-green">of {summary.qc_done || 0} reviewed</span>
              </div>
              <div className="dbv2-progress-bar">
                <div className="dbv2-progress-fill" style={{ width: `${summary.pass_percentage || 0}%`, background: '#10b981' }} />
              </div>
              <div className="dbv2-stat-foot">
                <span className="dbv2-foot-lbl">pass rate</span>
                <span className="dbv2-foot-val" style={{ color: '#16a34a' }}>{summary.pass_percentage || 0}%</span>
              </div>
            </div>

            {/* QA Failed / SLA */}
            <div
              className={`dbv2-stat c-red clickable ${showSla ? 'active-stat-red' : ''}`}
              onClick={() => setShowSla(true)}
            >
              <div className="dbv2-stat-icon ic-red">
                <i className="bi bi-exclamation-octagon-fill" style={{ color: '#ef4444', fontSize: 15 }}></i>
              </div>
              <div className="dbv2-stat-lbl">QA Failed / SLA</div>
              <div className="dbv2-stat-val red">
                {(viewMode === 'list' ? summary.failed : selAgent?.failed) || 0}
              </div>
              <div className="dbv2-stat-sub">
                {(summary.failed || 0) === 0
                  ? <span className="dbv2-chip chip-green">All clear</span>
                  : <span className="dbv2-chip chip-red">{summary.failed} failed</span>
                }
              </div>
              <div className="dbv2-progress-bar">
                <div className="dbv2-progress-fill" style={{ width: `${Math.max(failRate, 1)}%`, background: '#ef4444' }} />
              </div>
              <div className="dbv2-stat-foot">
                <span className="dbv2-foot-lbl">fail rate</span>
                <span className="dbv2-foot-val" style={{ color: (summary.failed || 0) === 0 ? '#16a34a' : '#dc2626' }}>
                  {failRate}%
                </span>
              </div>
            </div>
            ...
            {/* QA Completed */}
            <div className="dbv2-stat c-teal">
              <div className="dbv2-stat-icon ic-teal">
                <i className="bi bi-check2-all" style={{ color: '#14b8a6', fontSize: 15 }}></i>
              </div>
              <div className="dbv2-stat-lbl">QA Completed</div>
              <div className="dbv2-stat-val teal">{summary.qc_done || 0}</div>
              <div className="dbv2-stat-sub">
                <span className="dbv2-chip chip-teal">QC done</span>
              </div>
              <div className="dbv2-progress-bar">
                <div className="dbv2-progress-fill" style={{ width: `${Math.max(coveragePct, 1)}%`, background: '#14b8a6' }} />
              </div>
              <div className="dbv2-stat-foot">
                <span className="dbv2-foot-lbl">coverage</span>
                <span className="dbv2-foot-val" style={{ color: '#0d9488' }}>{coveragePct}% of {totalTix}</span>
              </div>
            </div>

            {/* Total QA Score */}
            <div className="dbv2-stat c-purple">
              <div className="dbv2-stat-icon ic-purple">
                <i className="bi bi-graph-up-arrow" style={{ color: '#8b5cf6', fontSize: 15 }}></i>
              </div>
              <div className="dbv2-stat-lbl">Total QA Score</div>
              <div className="dbv2-stat-val purple">
                {(viewMode === 'list' ? summary.pass_percentage : selAgent?.pass_percentage) || 0}%
              </div>
              <div className="dbv2-stat-sub">
                <span className="dbv2-chip chip-purple">Pass percentage</span>
              </div>
              <div className="dbv2-progress-bar">
                <div className="dbv2-progress-fill" style={{ width: `${summary.pass_percentage || 0}%`, background: 'linear-gradient(90deg,#8b5cf6,#6366f1)' }} />
              </div>
              <div className="dbv2-stat-foot">
