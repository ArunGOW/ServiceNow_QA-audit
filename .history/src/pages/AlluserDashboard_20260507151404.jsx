     ...
     <div className="db-root">
       ...
       {activeTab === 'team' && (
         <div className="db-banner">
           ...
           <div className="db-stat c-purple">
              <div className="db-stat-icon ic-purple">
                <i className="bi bi-graph-up-arrow" style={{ color: '#8b5cf6', fontSize: 15 }}></i>
              </div>
              <div className="db-stat-lbl">Total QA Score</div>
              <div className="db-stat-val purple">
              ...
              <div className="db-stat-foot">
                <span className="db-foot-lbl">all time</span>
                <span className="db-foot-val" style={{ color: '#7c3aed' }}>+{summary.pass_percentage || 0}%</span>
              </div>
            </div>
         </div>
       )}
