...
const AllusersDashboard = () => {
  ...
  <div className="dbs-banner">
    ...
    <div className="dbs-row dbs-row-3">
      ...
      <div className="dbs-card v">
        ...
        <div className="dbs-bar-track"><div className="dbs-bar-fill" style={{width:`${totalTix ? Math.round((incCount/totalTix)*100) : 0}%`,background:'#6366f1'}}/></div>
    ...
    <div className="dbs-row dbs-row-4">
      ...
      <div className={`dbs-card r click ${showSla?'dbs-red-active':''}`} onClick={()=>setShowSla(true)}>
        <div className="dbs-card-top">
          <div><div className="dbs-lbl">QA Failed / SLA</div>
        ...
        <div className="dbs-chips">
          ...
          <span className="dbs-chip neu">SLA {summary.sla_breached??0}</span>
        </div>
        <div className="dbs-bar-track"><div className="dbs-bar-fill" style={{width:`${Math.max(failRate,1)}%`,background:'#ef4444'}}/></div>
        <div className="dbs-divider"/>
        <div className="dbs-foot"><span className="dbs-foot-lbl">Fail rate</span><span className={`dbs-foot-val ${(summary.failed||0)===0?'g':'r'}`}>{failRate}%</span></div>
      </div>
