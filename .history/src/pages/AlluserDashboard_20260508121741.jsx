  ...
  <div className="db-card db-detail-card" style={{ flex: 1 }}>
    ...
    <div className="db-detail-head">
      ...
      <div className="db-detail-head-right">
        <div className="db-detail-hbadge">📋 {Math.ceil(detTotal / 10)} Pages</div>
        <div className="db-detail-hcount">{detTotal} Records</div>
      </div>
    </div>

    {/* ── FILTER BAR ── */}
    <div className="db-detail-filters">
      <DD label="Audit Phase" open={qaDropDet} setOpen={setQaDropDet} selected={selQaDet} opts={qaOpts}
        onSelect={v => { setDetQa(v); setDetPage(1); }} />
      <div className="db-flt">
        <label className="db-flbl">From</label>
        <input type="date" className="db-date" value={detFrom} onChange={e => setDetFrom(e.target.value)} />
      </div>
      <div className="db-flt">
        <label className="db-flbl">To</label>
        <input type="date" className="db-date" value={detTo} onChange={e => setDetTo(e.target.value)} />
      </div>
      <div className="db-flt">
        <label className="db-flbl">Reset</label>
        <button className="db-reset" onClick={() => { setDetFrom(''); setDetTo(''); setDetPage(1); }}>
          <i className="bi bi-arrow-counterclockwise"></i>
        </button>
      </div>
    </div>
    ...
    {/* ── TABLE ── */}
    <div className="db-table-wrap">
      <table className="db-table db-detail-table">
        <thead>
          <tr>
