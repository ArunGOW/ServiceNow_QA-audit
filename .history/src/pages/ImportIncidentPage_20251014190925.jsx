...
const ImportIncidentPage = () => {
  ...
  const handleImport = async (e) => {
    ...
    try {
      ...
      setUploaded(true); // still show close button even on error
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-4 d-flex justify-content-center">
      <Card className="p-4 shadow-lg rounded-4 import-card" style={{ maxWidth: "700px", width: "100%", position: "relative" }}>
        ...
        {/* Show close/reset button only after upload (success or failed) */}
        {uploaded && (
          <Button
            variant="danger"
            size="sm"
      ...
      <ToastContainer position="top-end" className="p-3">
        {uploaded && (
          <Toast
            ...
            delay={3000}
            autohide
            bg={response?.failed_imports > 0 ? "warning" : "success"}
          >
            <Toast.Header>
