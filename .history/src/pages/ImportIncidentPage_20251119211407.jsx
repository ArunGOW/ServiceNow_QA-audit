...
const handleRemoveFile = () => {
    ...
    <div className="p-4 d-flex justify-content-center">
      <Card className="p-4 shadow-lg rounded-4 import-card" style={{ maxWidth: "700px", width: "100%", position: "relative" }}>
        ...
        <Form onSubmit={handleImport}>
          ...
          <Form.Group controlId="formFile" className="mb-3">
  <Form.Label className="fw-semibold">Upload Excel</Form.Label>
  ...
  <div className="d-flex align-items-center gap-2">
    ...
    <Form.Control
      ...
      disabled={excelFile !== null} // disable input after selecting file
    />

    {/* Remove button appears only after a file is selected */}
    {excelFile && (
      <Button
        variant="danger"
        size="sm"
