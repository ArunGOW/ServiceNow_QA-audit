      ...
      <div style={styles.mainContainer}>
        ...
        <div style={styles.headerBanner}>
          ...
          <div className="d-flex align-items-center gap-3">
             <div style={styles.badge}>
                <i className="bi bi-cpu-fill me-2"></i> ONLINE
             </div>
          </div>
        </div>
        ...
        <div style={styles.contentArea}>
          ...
          <div style={styles.leftCol}>
            ...
            <Form onSubmit={handleSubmit} style={styles.formElement}>
              <Row className="g-2">
                <Col md={6}>
                  <Form.Label style={styles.label}>Incident ID</Form.Label>
                  <Form.Control name="incident_number" value={formData.incident_number} placeholder="INC..." style={styles.input} onChange={handleChange} required />
                </Col>
                <Col md={6}>
                ...
                <Col md={12}>
                  <Form.Label style={styles.label}>Internal Link</Form.Label>
              ...
              <div className="d-flex gap-2 mt-auto pt-3">
                <Button type="submit" style={styles.submitBtn} className="flex-grow-1 text-white border-0" disabled={loading}>
                  {loading ? <Spinner size="sm" /> : <i className="bi bi-cloud-arrow-up me-2"></i>}
          ...
          <div style={styles.rightCol}>
            <div style={styles.previewHeader}>
              <div style={styles.liveDot}></div> ACTIVITY HISTORY ({recentIncidents.length})
            ...
            <div style={styles.scrollContainer}>
              {recentIncidents.length === 0 ? (
                <div style={styles.emptyState}>
                  <i className="bi bi-database-exclamation mb-2" style={{fontSize: '1.5rem'}}></i>
                  <p style={{fontSize: '11px'}}>No Records</p>
                </div>
              ) : (
                recentIncidents.map((inc, index) => (
                  <div key={index} onClick={() => handleEdit(inc)} style={styles.previewItem}>
...
const styles = {
  pageWrapper: { 
    ...
    padding: '20px',
    overflow: 'hidden' // Strictly prevents page scroll
  },
  mainContainer: { 
    width: '100%', 
    maxWidth: '1000px', 
    height: '85vh', // Locks the container height to 85% of screen
    backgroundColor: '#fff', 
    borderRadius: '20px', 
    overflow: 'hidden', 
    display: 'flex', 
  ...
  bannerTitle: { color: '#fff', margin: 0, fontSize: '20px', fontWeight: '900', letterSpacing: '1px' },
  bannerSubtitle: { color: '#94a3b8', margin: 0, fontSize: '11px' },
  badge: { backgroundColor: 'rgba(16, 185, 129, 0.1)', color: '#10b981', padding: '4px 10px', borderRadius: '6px', fontSize: '10px', fontWeight: '800' },

  contentArea: { 
    display: 'flex', 
    flex: 1, 
    overflow: 'hidden', // Ensures children manage their own scrolls
    padding: '20px' 
  },
  leftCol: { 
    flex: 1.2, 
  ...
  sectionTitle: { fontWeight: '900', marginBottom: '15px', fontSize: '1.2rem' },
  label: { fontSize: '10px', fontWeight: '800', color: '#64748b', textTransform: 'uppercase', marginBottom: '4px' },
  input: { borderRadius: '8px', padding: '8px 12px', border: '1px solid #e2e8f0', fontSize: '13px', backgroundColor: '#f8fafc' },
  textarea: { borderRadius: '8px', padding: '10px', border: '1px solid #e2e8f0', fontSize: '13px', backgroundColor: '#f8fafc', resize: 'none' },
  select: { borderRadius: '8px', padding: '8px', border: '1px solid #e2e8f0', fontSize: '13px', fontWeight: '700' },
  
  submitBtn: { background: '#4f46e5', borderRadius: '10px', padding: '10px', fontWeight: '700', fontSize: '14px' },
  clearBtn: { borderRadius: '10px', border: '1px solid #e2e8f0', width: '45px' },

  previewHeader: { fontSize: '10px', fontWeight: '900', color: '#64748b', padding: '15px 0 10px 0', display: 'flex', alignItems: 'center', gap: '8px' },
  scrollContainer: { 
    overflowY: 'auto', 
    flex: 1, 
    paddingRight: '5px',
  ...
  statusPill: { padding: '2px 8px', borderRadius: '10px', fontSize: '8px', fontWeight: '900' },
  previewValue: { fontSize: '15px', fontWeight: '800', color: '#f8fafc' },
  previewSmallValue: { fontSize: '12px', color: '#94a3b8', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  emptyState: { textAlign: 'center', marginTop: '40px', color: '#475569' }
};
