...
const styles = {
  ...
  iconBox: { width: '50px', height: '50px', backgroundColor: 'rgba(172, 171, 181, 0.2)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#818cf8', fontSize: '24px', border: '1px solid rgba(129, 140, 248, 0.3)' },
