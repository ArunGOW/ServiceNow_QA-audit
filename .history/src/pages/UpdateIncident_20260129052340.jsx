        ...
        <div style={styles.previewSection} className="custom-scrollbar">
          ...
          {recentIncidents.map((inc, i) => (
            <div key={i} style={styles.historyCard}>
              <div className="d-flex justify-content-between align-items-center">
                <span style={{fontSize: '11px', fontWeight: 800,color: aliceblue}}>{inc.incident_number}</span>
...
const styles = {
  ...
  previewHeader: { fontSize: '9px', fontWeight: '900', color: '#475569', marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '8px' },
