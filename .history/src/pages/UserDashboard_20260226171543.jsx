                  ...
                  <tr key={i} style={styles.tr} onClick={() => { setSelectedAgent(agent); setIsModalOpen(true); }}>
                    <td style={styles.td}>
                      <div style={styles.agentInfo}>
                        ...
                        <span style={styles.nameText}>{agent.agent}</span>
                      </div>
                    </td>
                    <td style={styles.td}>{agent.total_tickets}</td>
                    <td style={{ ...styles.td, color: '#10b981', fontWeight: 'bold' }}>{agent.passed}</td>
...
const styles = {
  wrapper: { backgroundColor: '#f8fafc', height: '100vh', padding: '15px 25px', fontFamily: "'Inter', sans-serif", overflow: 'hidden' },
  
  // Header
  premiumHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', padding: '10px 0' },
  headerLeft: { display: 'flex', alignItems: 'center', gap: '15px' },
  logoBadge: { width: '42px', height: '42px', background: '#1e293b', borderRadius: '12px', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' },
  premiumLogo: { margin: 0, fontSize: '22px', fontWeight: '900', color: '#1e293b' },
  headerSub: { margin: 0, fontSize: '11px', color: '#94a3b8', fontWeight: '500' },
  headerRight: { display: 'flex', alignItems: 'center', gap: '20px' },
  statusPill: { background: '#fff', border: '1px solid #e2e8f0', padding: '6px 14px', borderRadius: '20px', fontSize: '11px', fontWeight: '700', color: '#64748b', display: 'flex', alignItems: 'center', gap: '8px' },
  pulse: { width: '8px', height: '8px', background: '#10b981', borderRadius: '50%', display: 'inline-block' },
  avatarPremium: { width: '40px', height: '40px', borderRadius: '50%', background: 'linear-gradient(135deg, #6366f1, #a855f7)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', boxShadow: '0 4px 10px rgba(99, 102, 241, 0.3)' },

  // KPI Row
  statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '15px', marginBottom: '20px' },
  metricTile: { background: '#fff', padding: '15px', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '15px', boxShadow: '0 2px 4px rgba(0,0,0,0.02)', border: '1px solid #f1f5f9' },
  iconBox: { width: '48px', height: '48px', borderRadius: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px' },
  tileLabel: { margin: 0, fontSize: '10px', fontWeight: '700', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.5px' },
  tileValue: { margin: '2px 0 0 0', fontSize: '20px', fontWeight: '800', color: '#1e293b' },

  // Layout
  mainLayout: { display: 'grid', gridTemplateColumns: '340px 1fr', gap: '20px', height: 'calc(100vh - 220px)' },
  chartContainer: { background: '#fff', padding: '20px', borderRadius: '24px', display: 'flex', flexDirection: 'column', border: '1px solid #f1f5f9' },
  cardTitle: { margin: '0 0 15px 0', fontSize: '15px', fontWeight: '800', color: '#1e293b' },
  customLegend: { marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '8px' },
  legendRow: { display: 'flex', alignItems: 'center', padding: '12px', background: '#f8fafc', borderRadius: '12px' },
  legendDot: { width: '8px', height: '8px', borderRadius: '50%', marginRight: '10px' },
  legendLabel: { fontSize: '12px', fontWeight: '600', color: '#64748b', flex: 1 },
  legendValue: { fontSize: '12px', fontWeight: '800', color: '#1e293b' },

  // Table
  tableCard: { background: '#fff', borderRadius: '24px', display: 'flex', flexDirection: 'column', overflow: 'hidden', border: '1px solid #f1f5f9' },
  tableHeader: { padding: '20px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  tableStats: { fontSize: '11px', fontWeight: '700', color: '#6366f1', background: '#f5f7ff', padding: '4px 12px', borderRadius: '20px' },
  tableScroll: { flex: 1, overflowY: 'auto', padding: '0 15px' },
  table: { width: '100%', borderCollapse: 'collapse' },
  th: { padding: '12px', fontSize: '10px', fontWeight: '800', color: '#94a3b8', textTransform: 'uppercase', textAlign: 'left', borderBottom: '1px solid #f1f5f9' },
  tr: { cursor: 'pointer', transition: '0.2s', borderBottom: '1px solid #f8fafc' },
  td: { padding: '14px 12px', fontSize: '13px', color: '#334155' },
  agentInfo: { display: 'flex', alignItems: 'center', gap: '10px' },
  miniAvatar: { width: '30px', height: '30px', borderRadius: '8px', background: '#f1f5f9', color: '#1e293b', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: 'bold' },
  nameText: { fontWeight: '700', color: '#1e293b' },
  ...
  loader: { height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#6366f1', fontWeight: '900', fontSize: '20px' }
};
